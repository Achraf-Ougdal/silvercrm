...
@section('page_header')
   <div class="container-fluid">
        ...
        <a href="#" class="btn btn-warning btn-add-new">
            <i class="voyager-eye"></i> <span>&nbsp;Voir l'historique des résidents</span>
        </a>
        <a href="#" class="btn btn-info btn-add-new">
            <i class="voyager-calendar"></i> <span>&nbsp;Voir les durées de séjours organismes</span>
        </a>
                            ...
                            <form method="get" class="form-search" action="{{route('elder.search')}}">
                               <div id="search-input">
                                    ...
                                    <div class="input-group col-md-12">
                                        <input type="text" class="form-control" placeholder="Nom du résident" name="elderName" value="{{ $search->value }}">
