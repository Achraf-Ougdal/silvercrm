...
class ElderController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id){
        ...
        $elderRoom = App\Elder_room::where('elder_id', $id)->get('room_id');

        if (count($elderRoom) > 0){
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'chambre'));
    }
}
